...
This means one can have an always-on SperoCoind instance running, and another local SperoCoind/SperoCoin-qt instance which connects to this node and receives blocks from it.
