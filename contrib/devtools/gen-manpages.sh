...
LITECOIND=${LITECOIND:-$SRCDIR/SperoCoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/SperoCoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/SperoCoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/SperoCoin-qt}
