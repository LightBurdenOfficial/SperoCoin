...
enum
{
    ...
    SCRIPT_VERIFY_CHECKLOCKTIMEVERIFY = (1U << 9), // support (BIP65) CHECKLOCKTIMEVERIFY
    SCRIPT_VERIFY_CHECKSEQUENCEVERIFY = (1U << 10) // support (BIP112) CHECKSEQUENCEVERIFY opcode
};
