...
// Copyright (c) 2014 The SperoCoin developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("sperocoin-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("sperocoin-smsg-pow"); // Make this thread recognisable
