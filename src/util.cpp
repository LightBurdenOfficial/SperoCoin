...
const char * const BITCOIN_CONF_FILENAME = "SperoCoin.conf";
const char * const BITCOIN_PID_FILENAME = "SperoCoind.pid";
...
const CLogCategoryDesc LogCategories[] =
{
    ...
    {BCLog::WALLET, "wallet"},
    {BCLog::SPEROVAULT, "sperovault"},
    {BCLog::SPEROSEND, "sperosend"},
    {BCLog::CHECKPOINT, "checkpoint"},
    {BCLog::FASTSYNC, "fastsync"},
    {BCLog::ALL, "1"},
    {BCLog::ALL, "all"},
};
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/SperoCoin";
#else
    // Unix
