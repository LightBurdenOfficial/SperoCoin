...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        std::string strDesc = "SperoCoin " + FormatFullVersion();
...
int CConnman::GetUpdatedServiceListCount()
{
	...
	// LogPrint(BCLog::SPEROSEND, ">> GetUpdatedServiceListCount: init sz = %d\n", sz);
	...
	// LogPrint(BCLog::SPEROSEND, ">> GetUpdatedServiceListCount: after sz = %d\n", sz);
