...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s SperoCoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  SperoCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded SperoCoin transaction") + "\n" +
              "  SperoCoin-tx [options] -create [commands]   " + _("Create hex-encoded SperoCoin transaction") + "\n" +
              "\n";
