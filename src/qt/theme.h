...
#ifndef SPEROCOIN_THEME_THEME_H
#define SPEROCOIN_THEME_THEME_H
...
public:
	...
	const QString getSperoCoinLogo() const;
    const QString getSendSperoSendIco() const;
...
protected:
    ...
    QString speroVaultLogoIco;
	QString speroVaultLogoBtnStyle;
    ...
    QString speroCoinLogo;
    QString sendSperoSendIco;
    QString spinnerPath;
