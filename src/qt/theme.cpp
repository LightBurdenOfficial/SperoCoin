...
void Theme::init() {
    ...
    speroVaultLogoBtnStyle = "background-color: " + frame_background + "; border: none";
...
const QString Theme::getDeepVaultLogoIco() const {
    return speroVaultLogoIco;
}

const QString Theme::getDeepVaultLogoBtnStyle() const {
    return speroVaultLogoBtnStyle;
}
...
const QString Theme::getSperoCoinLogo()const {
    return speroCoinLogo;
}

const QString Theme::getSendSperoSendIco()const {
    return sendSperoSendIco;
}
