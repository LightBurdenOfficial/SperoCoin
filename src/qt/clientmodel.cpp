...
bool ClientModel::isNewVersionAvailable()
{
    ...
    QUrl url("https://sperocoin.org/latestversion.txt");
    qInfo() << url.toString();
...
void ClientModel::setFastSyncUntarInfo(boost::filesystem::path tarDir, boost::filesystem::path targetDir, boost::filesystem::path tempDir)
{
    tarDir_ = tarDir;
    targetDir_ = targetDir;
    fastSyncTempDir_ = tempDir;
}

void ClientModel::getFastSyncUntarInfo(boost::filesystem::path& tarDir, boost::filesystem::path& targetDir, boost::filesystem::path& tempDir)
{
    tarDir = tarDir_;
    targetDir = targetDir_;
    tempDir = fastSyncTempDir_;
}
