...
To run the litecoind tests manually, launch `src/test/test_SperoCoin`. To recompile
...
To run the litecoin-qt tests manually, launch `src/qt/test/test_SperoCoin-qt`
