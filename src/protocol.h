...
enum ServiceFlags : uint64_t {
    ...
    NODE_XTHIN = (1 << 4),
    // NODE_SPERO_SEND mean the node supports the SperoSend Protocol and will
    // respond to SperoSend Protocol messages.
    // See TODO: Add a reference to SperoSend definition.
    NODE_SPERO_SEND = (1 << 7),
