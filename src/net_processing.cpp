...
static void broadcastServiceAnnounceMessage(CNode* pfrom, CConnman* connman)
{
    ...
    if((pfrom->GetLocalServices() & NODE_SPERO_SEND)) {
        ...
        LogPrint(BCLog::SPEROSEND, ">> broadcasting mixservice messages with b = %d to %s\n", b, pfrom->addr.ToString());
...
//        }
    ...
    else if (strCommand == NetMsgType::DS_SVCAVAIL) // message sender -> mixer
    {
        ...
        LogPrint(BCLog::SPEROSEND, ">> %s: anonymousTxId = %s, senderAddress = %s\n", strCommand, anonymousTxId.c_str(), senderAddress.c_str());
        ...
        LogPrint(BCLog::SPEROSEND, ">> %s: mixer selfAddress = %s\n", strCommand, selfAddress.c_str());
...

        {
            ...
            LogPrint(BCLog::SPEROSEND, ">> %s: guarantorKey = %s\n", strCommand, guarantorKey.c_str());
    ...
    else if (strCommand == NetMsgType::DS_SVCREPLY) // message mixer -> sender
    {
        ...
        LogPrint(BCLog::SPEROSEND, ">> %s: anonymousTxId = %s, mixerAddress = %s, guarantorAddress = %s\n", 
    ...
    else if (strCommand == NetMsgType::DS_GRNTREQ)  // message sender -> guarantor
    {
        ...
        LogPrint(BCLog::SPEROSEND, ">> %s: anonymousTxId = %s, senderAddress = %s, senderPubKey = %s, keyMixer = %s\n",
