...
static const int64_t BLOCK_DOWNLOAD_TIMEOUT_PER_PEER = 250000;
...
/** SperoSend service default, currently its an opt in service. */
static const bool DEFAULT_SPEROSENDNODE = false;
...
extern CCriticalSection cs_sperosend;
