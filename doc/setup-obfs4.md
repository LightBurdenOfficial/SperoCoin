...
#### Activate obfs4 functionality in SperoCoin.conf

Open your *SperoCoin.conf* and add those two lines:
...
* Windows - %APPDATA%/Roaming/SperoCoin/tor
...
* Linux - ~/.SperoCoin/tor
* Mac -  ~/Library/Application Support/SperoCoin/tor
...
As Windows has no default Package Manager there are several ways to get **obfs4proxy.exe**. One could simply install the Tor-Browser manually and put the provided **obfs4proxy.exe** into the directory of your SperoCoin installation. 
