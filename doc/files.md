...
* SperoCoin.conf: contains configuration settings for SperoCoind or SperoCoin-qt
* SperoCoind.pid: stores the process id of SperoCoind while running
...
* debug.log: contains debug information and general logging generated by SperoCoind or SperoCoin-qt
